...
#   python quick_pca.py topology.pdb trajectory.nc
#   python quick_pca.py topology.pdb trajectory.dcd
#   python quick_pca.py topology.pdb               # multi-model PDB
#   python quick_pca.py topology.pdb traj.nc --interval 10 --temp 310
...
def _detect_pymol():
    ...
    In plain  python quick_pca.py  sys.argv[0] is the script itself.
...
def main():
    ...
    if PYMOL_MODE:
        ...
        parser = argparse.ArgumentParser(
            ...
            epilog="""
Examples:
  python quick_pca.py protein.pdb traj.nc
  python quick_pca.py protein.pdb traj.dcd
  python quick_pca.py multimodel.pdb
  python quick_pca.py protein.pdb traj.nc --interval 10 --temp 310
            """
        )
